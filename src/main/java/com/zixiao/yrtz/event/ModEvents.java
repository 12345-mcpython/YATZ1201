...
public class ModEvents {
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(ModEntities.RENZHE_STEVE.get(), renzheSteveEntity.createAttributes().build());
        event.put(ModEntities.DEAD_RENZHE_STEVE.get(), deadrenzheSteveEntity.createAttributes().build());
