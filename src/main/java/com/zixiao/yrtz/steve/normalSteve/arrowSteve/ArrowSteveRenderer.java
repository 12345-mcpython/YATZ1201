package com.zixiao.yrtz.steve.normalSteve.arrowSteve;
...
public class ArrowSteveRenderer extends MobRenderer<
        ArrowSteveEntity,
        HumanoidModel<ArrowSteveEntity>> {

    public ArrowSteveRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    public ResourceLocation getTextureLocation(ArrowSteveEntity entity) {
    ...
    @Override
    public void render(ArrowSteveEntity entity,
                       float entityYaw,
                       float partialTicks,
                       PoseStack poseStack,
                       MultiBufferSource buffer,
                       int packedLight) {
        HumanoidModel<ArrowSteveEntity> model = this.getModel();
