...
public class MinerSteveRenderer extends MobRenderer<
        MinerSteveEntity,
        HumanoidModel<MinerSteveEntity>> {

    public MinerSteveRenderer(EntityRendererProvider.Context context) {
        super(
                context,
    ...
    @Override
    public ResourceLocation getTextureLocation(MinerSteveEntity entity) {
    ...
    @Override
    public void render(MinerSteveEntity entity,
                       float entityYaw,
                       float partialTicks,
                       PoseStack poseStack,
