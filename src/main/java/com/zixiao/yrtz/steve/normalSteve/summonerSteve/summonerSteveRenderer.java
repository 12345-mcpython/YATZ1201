...
public class summonerSteveRenderer extends MobRenderer<
        summonerSteveEntity,
        HumanoidModel<summonerSteveEntity>> {

    public summonerSteveRenderer(EntityRendererProvider.Context context) {
        super(
                context,
    ...
    @Override
    public ResourceLocation getTextureLocation(summonerSteveEntity entity) {
    ...
    @Override
    public void render(summonerSteveEntity entity,
                       float entityYaw,
                       float partialTicks,
                       PoseStack poseStack,
