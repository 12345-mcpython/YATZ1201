...
public class SummonerSteveEntity extends NormalSteveEntity {

    public SummonerSteveEntity(EntityType<? extends ModMonster> type, Level level) {
        super(type, level);
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide) {
            ...
            if (this.random.nextInt(250) == 0) {
                ...
                SummonedSteveEntity summoned = new SummonedSteveEntity(
