...
public class arrowSteveEntity extends normalSteveEntity implements RangedAttackMob {
    private final RangedBowAttackGoal<arrowSteveEntity> bowGoal =
    ...
    private final MeleeAttackGoal meleeGoal =
            new MeleeAttackGoal(this, 1.2D, false) {
                ...
                public void start() {
                    super.start();
                    arrowSteveEntity.this.setAggressive(true);
                }

                @Override
                public void stop() {
                    super.stop();
                    arrowSteveEntity.this.setAggressive(false);
                }
            };

    public arrowSteveEntity(EntityType<? extends arrowSteveEntity> type, Level level) {
        super(type, level);
