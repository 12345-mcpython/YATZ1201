...
public class fireSteveRenderer extends MobRenderer<
        fireSteveEntity,
        HumanoidModel<fireSteveEntity>> {

    public fireSteveRenderer(EntityRendererProvider.Context context) {
        super(
                context,
    ...
    @Override
    public ResourceLocation getTextureLocation(fireSteveEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(
                "yrtz",
                "textures/entity/steve/firesteve.png"
        );
    }

    @Override
    public void render(fireSteveEntity entity,
                       float entityYaw,
                       float partialTicks,
                       PoseStack poseStack,
